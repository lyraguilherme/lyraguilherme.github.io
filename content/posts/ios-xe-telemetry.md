...
![InfluxDB Get Started](/images/ios-xe-telemetry/image_1.png)
*Click GET STARTED and (1) set up an account, (2) create a bucket and (3) create an API Token for Telegraf*

![InfluxDB Initial User Setup](/images/ios-xe-telemetry/image_2.png)
*Click CONFIGURE LATER*

![InfluxDB Getting Started](/images/ios-xe-telemetry/image_3.png)
*Expand the left-side menu and click LOAD DATA*

![InfluxDB Load Data](/images/ios-xe-telemetry/image_4.png)
*Go to API TOKENS and click GENERATE API TOKEN*

![InfluxDB Custom API Token](/images/ios-xe-telemetry/image_5.png)
*Give it read+write permissions under bucket named telegraf and click GENERATE*

![InfluxDB Telegraf API Token](/images/ios-xe-telemetry/image_6.png)
...
![InfluxDB Data Explorer](/images/ios-xe-telemetry/image_10.png)
...
![InfluxDB Data Explorer](/images/ios-xe-telemetry/image_11.jpg)
...
![InfluxDB Data Explorer](/images/ios-xe-telemetry/image_12.jpg)
*Adding the graph to a new dashboard*

![InfluxDB Data Explorer](/images/ios-xe-telemetry/image_13.jpg)
*Some of the available options*

![InfluxDB MDT Dashboard](/images/ios-xe-telemetry/image_14.png)
